...
with h5py.File(arg.ffly, 'a') as f:
    ...
    summ_grp = f.require_group('/summary')
    summ_grp.attrs['max_lat'] = params['latitude'].max()
    summ_grp.attrs['min_lat'] = params['latitude'].min()
    summ_grp.attrs['max_lon'] = params['longitude'].max()
    summ_grp.attrs['min_lon'] = params['longitude'].min()
    summ_grp.attrs['max_pitch'] = params['pitch'].max()
    summ_grp.attrs['min_pitch'] = params['pitch'].min()
    summ_grp.attrs['max_roll'] = params['roll'].max()
    summ_grp.attrs['min_roll'] = params['roll'].min()
    summ_grp.attrs['max_altitude'] = params['altitude'].max()
    summ_grp.attrs['min_altitude'] = params['altitude'].min()
    summ_grp.attrs['max_speed'] = params['speed'].max()
    summ_grp.attrs['min_speed'] = params['speed'].min()
    summ_grp.attrs['max_gforce'] = params['g-force'].max()
    summ_grp.attrs['min_gforce'] = params['g-force'].min()
